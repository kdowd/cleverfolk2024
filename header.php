...
<body id="override" <?php body_class(); ?>>
    ...
    <header class="site-header group">
        ...
        <div class="menu-widgets-area">
            ...
            <div style="display:flex; gap: 4rem" ;>
                ...
                <!-- click for the mobile menu which will make visible .mobile-menu-wrapper -->
    ...
    <!-- made visible afrer hamburger click -->
        ...
        <div class="close-mobile-menu">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                <path fill="currentColor"
                    d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8m8-1.414l-2-2L4.586 6l2 2l-2 2L6 11.414l2-2l2 2L11.414 10l-2-2l2-2L10 4.586z" />
            </svg>
        </div>
